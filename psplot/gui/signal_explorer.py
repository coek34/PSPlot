...
class SignalExplorerDialog(QDialog):
    ...
    def __init__(self, imported_data, existing_signals=None, parent=None):
        ...
        self.setModal(True)
        self.resize(1000, 700) # Slightly larger for better visibility
    ...
    def setup_ui(self):
        ...
        splitter.addWidget(self.selected_signals_tree)
        ...
        # Apply specific button colors from theme
        ok_button.setStyleSheet(current_theme.get_button_ok_style())
        cancel_button.setStyleSheet(current_theme.get_button_cancel_style())
        clear_button.setStyleSheet(current_theme.get_button_cancel_style().replace(current_theme.colors.danger, "#555"))
        ...
        # Apply global theme stylesheet to the whole dialog
