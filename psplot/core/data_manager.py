...
import logging
import numpy as np
from psplot.readers.pscad_reader import PSCADReader
from psplot.readers.comtrade_reader import ComtradeReader
from psplot.readers.csv_reader import CSVReader
...
class DataManager:
    ...
    def import_pscad_data(self):
        ...
        from psplot.readers.data_import import DataImportDialog
