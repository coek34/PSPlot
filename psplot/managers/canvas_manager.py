...
from psplot.gui.signal_explorer import SignalExplorerDialog
...
class CanvasManager:
    ...
    def new_canvas(self):
        ...
        if current_page:
            ...
            from psplot.gui.canvas_size_dialog import CanvasSizeDialog
    ...
    def resize_current_page(self):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            from psplot.plot_canvas import InteractivePlotCanvas
    ...
    def adjust_margins(self):
        ...
        from psplot.gui.margin_dialog import MarginDialog
